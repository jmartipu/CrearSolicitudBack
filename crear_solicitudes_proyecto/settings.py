"""
Django settings for crear_solicitudes_proyecto project.
...
SECRET_KEY = '0z#z6p&q^!1)j1ck0c!-8p_9vg@id4i__7qtax8rvithhn&zqm'
...
WSGI_APPLICATION = 'crear_solicitudes_proyecto.wsgi.application'


# Database
# https://docs.djangoproject.com/en/2.2/ref/settings/#databases
USE_POSTGRESQL = os.environ.get('USE_POSTGRESQL')
if USE_POSTGRESQL == "True": # Si tiene la variable de entorno usa PostgreSQL si no sigue usando SQLite3
    DATABASES = {
        'default': {
